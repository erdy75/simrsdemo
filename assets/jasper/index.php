...
Organization: <a href='http://www.simit.com.my'>Sim IT Sdn Bhd</a><br>
    ...
    <p><B>Example:</B></p>
    <ul>
	<a href='dodo/sample1.php' target='_blank'><button type="button" id="sample" >Sample</button>/<a>
    <li><a href='dodo/sample1.php' target='_blank'>Sample 9 <a> (Standard Parent and Child Report)</li>
