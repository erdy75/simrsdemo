<table>
  <tbody>
    <tr>
      ...
      <td style="padding:5px;">
        <input type="text" name="tgl_faktur" id="tgl_faktur" readonly="true" value="<?=$this->date->konversi2a($datalist['tgl'])?>">
      </td>
    </tr>
    <tr>
      <td style="padding:5px;">Fakt Supplier : </td>
      <td style="padding:5px;">
      <input type="text" name="fakt_supplier" id="fakt_supplier"  value="<?=$datalist['faktur_supplier']?>">
      </td>
      <td style="padding:5px;">
        Tgl terima :
      </td>
      <td style="padding:5px;">
        <input type="text" name="tgl_terima" id="tgl_terima" readonly="true" value="<?=date('d-m-Y');?>">
      </td>
    </tr>
    <tr>
