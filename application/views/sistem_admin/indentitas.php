    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <div class="box-header">
            <h3 class="box-title">Indentitas</h3>
            <div class="box-tools">
          ...
          <!-- end box-header -->
          <!-- begin box-body -->
          <div class="box-body" id="ajax_indentitas">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- begin box-header -->
          <div class="box-header">
            <h3 class="box-title">Edit dan Tambah Indentitas</h3>
          </div>
          <!-- end box-header -->
          <!-- begin box-body -->
          <div class="box-body">
          <form id="form_modul" action="<?=base_url()?>index.php/sistem/indentitas/edit/" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <table width="100%">
              <tbody>
                <?php echo input_text_1('Indentitas', 'indentitas', 'indentitas'); ?>
                <tr>
...
$('#indentitas').addClass('active');
$.ajax({
  type: "GET",
  data: "ajax=1&filter=",
  url: "<?=base_url()?>index.php/sistem/indentitas/ajax_indentitas",
  success: function(msg) {
    $("div#ajax_indentitas").html(msg);
  }
});
...
$("button#hapus").click(function() {
  ...
  if (r == true) {
      $("#form_modul").attr("action", "<?=base_url()?>index.php/sistem/indentitas/delete/");
      txt = "You pressed OK!";
      alert(txt);
  } else {
