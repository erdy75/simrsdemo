    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- end box-header -->
          <!-- begin box-body -->
          <div class="box-body" id="ajax_desa">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- begin box-body -->
          <div class="box-body">
          <form id="form_modul" action="<?=base_url()?>index.php/sistem/desa/edit/" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <table width="100%">
              <tbody>
                <?php echo $select2 ?>
                <?php echo input_text_1('Desa / Kelurahan', 'nama desa / Kelurahan', 'nama'); ?>
                <?php echo input_text_1('kodepos', '4xxxxx', 'kodepos'); ?>
                <tr>
...
$.ajax({
  type: "GET",
  data: "ajax=1&filter=",
  url: "<?=base_url()?>index.php/sistem/desa/ajax_desa",
...
$("button#hapus").click(function() {
  ...
  if (r == true) {
      $("#form_modul").attr("action", "<?=base_url()?>index.php/sistem/desa/delete/");
      txt = "You pressed OK!";
      alert(txt);
  } else {
