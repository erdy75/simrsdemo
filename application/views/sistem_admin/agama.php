    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- end box-header -->
          <!-- begin box-body -->
          <div class="box-body" id="ajax_agama">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- begin box-header -->
          <div class="box-header">
            <h3 class="box-title">Edit dan Tambah Agama</h3>
          </div>
          <!-- end box-header -->
          <!-- begin box-body -->
          <div class="box-body">
          <form id="form_modul" action="<?=base_url()?>index.php/sistem/agama/edit/" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <table width="100%">
              <tbody>
                <?php echo input_text_1('Agama', 'agama', 'agama'); ?>
                <tr>
...
$.ajax({
  type: "GET",
  data: "ajax=1&filter=",
  url: "<?=base_url()?>index.php/sistem/agama/ajax_agama",
...
$("button#hapus").click(function() {
  ...
  if (r == true) {
      $("#form_modul").attr("action", "<?=base_url()?>index.php/sistem/agama/delete/");
      txt = "You pressed OK!";
      alert(txt);
  } else {
