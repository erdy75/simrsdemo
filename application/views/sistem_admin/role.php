    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- end box-header -->
          <!-- begin box-body -->
          <div class="box-body" id="ajax_role">
      ...
      <div class="col-md-6">
        <div class="box box-success">
          ...
          <!-- begin box-body -->
          <div class="box-body">
          <form id="form_modul" action="<?=base_url()?>index.php/sistem/role/edit/" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            <table width="100%">
              <tbody>
                <?php echo input_text_1('Nama Role', 'Nama role baru', 'nama'); ?>
                <tr>
...
$("button#btn_ajax_cari").click(function() {
  ...
  $.ajax({
    ...
    url: "<?=base_url()?>index.php/sistem/role/ajax_role",
    success: function(msg) {
      $("div#ajax_role").html(msg);
    }
  });
});
// end cari
...
$("button#hapus").click(function() {
  ...
  if (r == true) {
      $("#form_modul").attr("action", "<?=base_url()?>index.php/sistem/role/delete/");
      // txt = "You pressed OK!";
      // alert(txt);
  } else {
